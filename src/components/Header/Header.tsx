      ...
      <div className='container'>
        <div className='flex justify-end'>
          <Popover
            ...
            renderPopover={
              <div className='relative rounded-md border border-gray-200 bg-white text-white shadow-md'>
          ...
          >
            ...
            <span className='mx-1 text-white'>Tiếng Việt</span>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
              viewBox='0 0 24 24'
          ...
          >
            <div className='mr-2 h-6 w-6 flex-shrink-0'>
              <img
                ...
                src='https://cf.shopee.vn/file/21caeaa408336755204743a0942f6742_tn'
                alt=''
              />
            </div>
            <div className='text-white'>ThinhgiaDoan</div>
          </Popover>
        </div>
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://cf.shopee.vn/file/vn-11134201-23020-tztg6dlbbtnv1c_tn'
                            alt='anh'
                        ...
                        <div className='ml-2 flex-grow overflow-hidden'>
                          <div className='truncate'>
                            Chia sẻ: Đã thích (1) Switch Duhuk Zuoce Smoothie V2
                            | Bản nâng cấp của Smoothie v1 siêu ngon | Linear |
                            5 Pin | KITCAP
                          </div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <div className='text-orange'>500.000đ</div>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
